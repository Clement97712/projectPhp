...
<div class="uk-background-cover uk-height-large" style="background-image: url(https://picsum.photos/g/1600/500);">
    ...
    <div class="uk-navbar-left">
        ...
        <ul class="uk-navbar-nav">
            <li class="uk-active"><a href="index.php"><h3>Vybz</h3></a></li>
        </ul>
    ...
    <div class="uk-navbar-right">
        ...
        <ul class="uk-navbar-nav uk-visible@s">
            <li class="uk-active"><a href="events.php">Events</a></li>
            <li class="uk-active"><a href="insert.php">Insert</a></li>
    ...
    <p class="title uk-container uk-container-small">This is why we love Music</p>
</div>
...
<div id="offcanvas-slide" uk-offcanvas>
    <div class="uk-offcanvas-bar">
        ...
        <ul class="uk-nav uk-nav-default">
            <li class="uk-nav-header"><a href="index.php">Vybz</a></li>
            <li></li>
            <li class="uk-active"><br/></li>
